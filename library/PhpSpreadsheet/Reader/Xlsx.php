...
namespace Library\PhpSpreadsheet\Reader;

use Library\PhpSpreadsheet\Cell\Coordinate;
use Library\PhpSpreadsheet\Cell\DataType;
use Library\PhpSpreadsheet\Cell\Hyperlink;
use Library\PhpSpreadsheet\DefinedName;
use Library\PhpSpreadsheet\Reader\Security\XmlScanner;
use Library\PhpSpreadsheet\Reader\Xlsx\AutoFilter;
use Library\PhpSpreadsheet\Reader\Xlsx\Chart;
use Library\PhpSpreadsheet\Reader\Xlsx\ColumnAndRowAttributes;
use Library\PhpSpreadsheet\Reader\Xlsx\ConditionalStyles;
use Library\PhpSpreadsheet\Reader\Xlsx\DataValidations;
use Library\PhpSpreadsheet\Reader\Xlsx\Hyperlinks;
use Library\PhpSpreadsheet\Reader\Xlsx\Namespaces;
use Library\PhpSpreadsheet\Reader\Xlsx\PageSetup;
use Library\PhpSpreadsheet\Reader\Xlsx\Properties as PropertyReader;
use Library\PhpSpreadsheet\Reader\Xlsx\SheetViewOptions;
use Library\PhpSpreadsheet\Reader\Xlsx\SheetViews;
use Library\PhpSpreadsheet\Reader\Xlsx\Styles;
use Library\PhpSpreadsheet\ReferenceHelper;
use Library\PhpSpreadsheet\RichText\RichText;
use Library\PhpSpreadsheet\Settings;
use Library\PhpSpreadsheet\Shared\Date;
use Library\PhpSpreadsheet\Shared\Drawing;
use Library\PhpSpreadsheet\Shared\File;
use Library\PhpSpreadsheet\Shared\Font;
...
use Library\PhpSpreadsheet\Style\Style;
...
class Xlsx extends BaseReader
{
                                        ...
                                        if ($xmlDrawingChildren->oneCellAnchor) {
                                            foreach ($xmlDrawingChildren->oneCellAnchor as $oneCellAnchor) {
                                                if ($oneCellAnchor->pic->blipFill) {
                                                    ...
                                                    $objDrawing = new \Library\PhpSpreadsheet\Worksheet\Drawing();
                ...
                foreach ($is->r as $run) {
                    if (!isset($run->rPr)) {
                        ...
                        if (isset($run->rPr->u) && !isset($run->rPr->u['val'])) {
                            $objText->getFont()->setUnderline(\Library\PhpSpreadsheet\Style\Font::UNDERLINE_SINGLE);
    ...
    /**
     * @param \Library\PhpSpreadsheet\Worksheet\Drawing $objDrawing
