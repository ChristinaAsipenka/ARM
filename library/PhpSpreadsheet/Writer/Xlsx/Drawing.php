...
namespace Library\PhpSpreadsheet\Writer\Xlsx;

use Library\PhpSpreadsheet\Cell\Coordinate;
use Library\PhpSpreadsheet\Shared\XMLWriter;
use Library\PhpSpreadsheet\Spreadsheet;
use Library\PhpSpreadsheet\Worksheet\BaseDrawing;
use Library\PhpSpreadsheet\Worksheet\HeaderFooterDrawing;
use Library\PhpSpreadsheet\Writer\Exception as WriterException;
...
class Drawing extends WriterPart
{
     ...
     */
    public function writeDrawings(\Library\PhpSpreadsheet\Worksheet\Worksheet $pWorksheet, $includeCharts = false)
    {
        // Create XML writer
        $objWriter = null;
     ...
     */
    public function writeChart(XMLWriter $objWriter, \Library\PhpSpreadsheet\Chart\Chart $pChart, $pRelationId = -1): void
    {
        ...
        $objWriter->writeElement('xdr:colOff', \Library\PhpSpreadsheet\Shared\Drawing::pixelsToEMU($tl['xOffset']));
        $objWriter->writeElement('xdr:row', $tlColRow[1] - 1);
        $objWriter->writeElement('xdr:rowOff', \Library\PhpSpreadsheet\Shared\Drawing::pixelsToEMU($tl['yOffset']));
        $objWriter->endElement();
        $objWriter->startElement('xdr:to');
        $objWriter->writeElement('xdr:col', $brColRow[0] - 1);
        $objWriter->writeElement('xdr:colOff', \Library\PhpSpreadsheet\Shared\Drawing::pixelsToEMU($br['xOffset']));
        $objWriter->writeElement('xdr:row', $brColRow[1] - 1);
        $objWriter->writeElement('xdr:rowOff', \Library\PhpSpreadsheet\Shared\Drawing::pixelsToEMU($br['yOffset']));
        $objWriter->endElement();
    ...
    public function writeDrawing(XMLWriter $objWriter, BaseDrawing $pDrawing, $pRelationId = -1, $hlinkClickId = null): void
    {
        if ($pRelationId >= 0) {
            ...
            $objWriter->writeElement('xdr:colOff', \Library\PhpSpreadsheet\Shared\Drawing::pixelsToEMU($pDrawing->getOffsetX()));
            $objWriter->writeElement('xdr:row', $aCoordinates[1] - 1);
            $objWriter->writeElement('xdr:rowOff', \Library\PhpSpreadsheet\Shared\Drawing::pixelsToEMU($pDrawing->getOffsetY()));
            $objWriter->endElement();

            // xdr:ext
            $objWriter->startElement('xdr:ext');
            $objWriter->writeAttribute('cx', \Library\PhpSpreadsheet\Shared\Drawing::pixelsToEMU($pDrawing->getWidth()));
            $objWriter->writeAttribute('cy', \Library\PhpSpreadsheet\Shared\Drawing::pixelsToEMU($pDrawing->getHeight()));
            $objWriter->endElement();
            ...
            $objWriter->writeAttribute('rot', \Library\PhpSpreadsheet\Shared\Drawing::degreesToAngle($pDrawing->getRotation()));
            $objWriter->endElement();
            ...
            if ($pDrawing->getShadow()->getVisible()) {
                ...
                $objWriter->writeAttribute('blurRad', \Library\PhpSpreadsheet\Shared\Drawing::pixelsToEMU($pDrawing->getShadow()->getBlurRadius()));
                $objWriter->writeAttribute('dist', \Library\PhpSpreadsheet\Shared\Drawing::pixelsToEMU($pDrawing->getShadow()->getDistance()));
                $objWriter->writeAttribute('dir', \Library\PhpSpreadsheet\Shared\Drawing::degreesToAngle($pDrawing->getShadow()->getDirection()));
     ...
     * @return string XML Output
     */
    public function writeVMLHeaderFooterImages(\Library\PhpSpreadsheet\Worksheet\Worksheet $pWorksheet)
    {
        // Create XML writer
        $objWriter = null;
        if ($this->getParentWriter()->getUseDiskCaching()) {
     ...
     *
     * @return \Library\PhpSpreadsheet\Worksheet\Drawing[] All drawings in PhpSpreadsheet
     */
