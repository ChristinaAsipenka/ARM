...
class SubjectRepository extends Model
{
    ...
    {
        $sql = $this->queryBuilder->select('reestr_subject.id AS id, COUNT(DISTINCT reestr_object.id) AS count_objects, reestr_subject.name AS name, reestr_subject.num_case_s AS num_case_s, reestr_object.id AS object_id, reestr_object.name AS object_name, spr_branch.sokr_name AS spr_branch_name, spr_podrazdelenie.sokr_name AS spr_name_podrazd, spr_otdel.sokr_name AS spr_name_otdel, reestr_subject.id_unp AS id_unp, reestr_subject.id_ind_pers AS id_ind_pers, SUM(reestr_object.elektro_is) AS sum_objects_el, SUM(reestr_object.t_is) AS sum_objects_t, SUM(reestr_object.ti_is) AS sum_objects_ti, SUM(reestr_object.gaz_is) AS sum_objects_gaz')
            ->from('reestr_subject')
			->joinLeftTable('reestr_object', 'reestr_subject.id = reestr_object.id_reestr_subject')
			->joinLeftTable('users', 'users.id = reestr_object.e_insp || users.id = reestr_object.t_insp || users.id = reestr_object.g_insp')
			...
			->where('users.spr_cod_podrazd', $spr_podrazdelenie)
    ...
    {
        $sql = $this->queryBuilder->select('reestr_subject.id AS id, reestr_subject.name AS name, reestr_subject.num_case_s AS num_case_s, reestr_object.id AS object_id, reestr_object.name AS object_name, spr_branch.sokr_name AS spr_branch_name, spr_podrazdelenie.sokr_name AS spr_name_podrazd, spr_otdel.sokr_name AS spr_name_otdel, COUNT(DISTINCT reestr_object.id) AS count_objects, reestr_subject.id_unp AS id_unp, SUM(reestr_object.elektro_is) AS sum_objects_el, SUM(reestr_object.t_is) AS sum_objects_t, SUM(reestr_object.ti_is) AS sum_objects_ti, SUM(reestr_object.gaz_is) AS sum_objects_gaz')
            ->from('reestr_subject')
			->joinLeftTable('reestr_object', 'reestr_subject.id = reestr_object.id_reestr_subject')
			//->joinLeftTable('users', 'users.id = reestr_object.e_insp || users.id = reestr_object.t_insp || users.id = reestr_object.g_insp')
			//->joinLeftTable('users as users_t', 'users_t.id = reestr_object.t_insp')
	...
	public function getSubjectCount()
    {
        ...
        $sql = $this->queryBuilder->createIndex('reestr_subject_name', 'reestr_subject', 'id, name');
		$sql = $this->queryBuilder->sql();
		$this->db->query($sql);

		$sql = $this->queryBuilder->select('reestr_subject.id AS id, COUNT(DISTINCT reestr_object.id) AS count_objects')
            ->from('reestr_subject')
			->joinLeftTable('reestr_object', 'reestr_subject.id = reestr_object.id_reestr_subject')
			->groupBy('reestr_subject.id', 'ASC')
            ->orderBy('reestr_subject.name', 'ASC')
		...
		$sql = $this->queryBuilder->dropIndex('reestr_subject_name', 'reestr_subject');
		$sql = $this->queryBuilder->sql();
		$this->db->query($sql);		
...
// список потребителей закрепленных за ответственным лицом	
	public function getSubjectByOtv($id)
    {
	   ...
	   $sql = $this->queryBuilder->select('reestr_subject.id AS id, reestr_subject.name AS name, reestr_subject.num_case_s AS num_case_s, spr_branch.sokr_name AS spr_branch_name, spr_podrazdelenie.sokr_name AS spr_name_podrazd, spr_otdel.sokr_name AS spr_name_otdel, COUNT(DISTINCT reestr_object.id) AS count_objects, spr_city.name AS fname, reestr_subject.otv_e1 AS otv_e1, reestr_subject.otv_e2 AS otv_e2, reestr_subject.otv_e3 AS otv_e3, reestr_subject.otv_t AS otv_t, reestr_subject.otv_t1 AS otv_t1, reestr_subject.otv_t2 AS otv_t2, reestr_subject.otv_t3 AS otv_t3, reestr_subject.otv_e AS otv_e, reestr_subject.otv_g AS otv_g, reestr_subject.otv_g1 AS otv_g1')
            ->from('reestr_subject')
			->joinLeftTable('spr_branch as spr_branch', 'spr_branch.id = reestr_subject.spr_branch')
			->joinLeftTable('spr_podrazdelenie as spr_podrazdelenie', 'spr_podrazdelenie.id = reestr_subject.spr_podrazdelenie')
			->joinLeftTable('spr_otdel as spr_otdel', 'spr_otdel.id = reestr_subject.spr_otdel')
			...
			->orWhere('reestr_subject.otv_e3', $id)
			->orWhere('reestr_subject.otv_t', $id)
			->orWhere('reestr_subject.otv_t1', $id)
			->orWhere('reestr_subject.otv_t2', $id)
			->orWhere('reestr_subject.otv_t3', $id)
...
/** Потребители заданного филиала */	
	public function getSubjectByBranch($spr_branch)
    {
        ...
        $sql = $this->queryBuilder->createIndex('reestr_subject_name', 'reestr_subject', 'id, name');
		$sql = $this->queryBuilder->createIndex('reestr_object_name', 'reestr_object', 'id_reestr_subject');
		$sql = $this->queryBuilder->createIndex('users_name', 'users', 'id');
		$sql = $this->queryBuilder->createIndex('spr_branch_name', 'spr_branch', 'id');
		$sql = $this->queryBuilder->createIndex('spr_podrazdelenie_name', 'spr_podrazdelenie', 'id');
		$sql = $this->queryBuilder->createIndex('spr_otdel_name', 'spr_otdel', 'id');
		$sql = $this->queryBuilder->sql();
		$this->db->query($sql);
		...
		$sql = $this->queryBuilder->select('reestr_subject.id AS id, COUNT(DISTINCT reestr_object.id) AS count_objects, reestr_subject.name AS name, reestr_subject.num_case_s AS num_case_s, reestr_object.id AS object_id, reestr_object.name AS object_name, spr_branch.sokr_name AS spr_branch_name, spr_podrazdelenie.sokr_name AS spr_name_podrazd, spr_otdel.sokr_name AS spr_name_otdel, reestr_subject.id_unp AS id_unp, reestr_subject.id_ind_pers AS id_ind_pers, SUM(reestr_object.elektro_is) AS sum_objects_el, SUM(reestr_object.t_is) AS sum_objects_t, SUM(reestr_object.ti_is) AS sum_objects_ti, SUM(reestr_object.gaz_is) AS sum_objects_gaz')
            ->from('reestr_subject')
			->joinLeftTable('reestr_object', 'reestr_subject.id = reestr_object.id_reestr_subject')
			->joinLeftTable('users', 'users.id = reestr_object.e_insp || users.id = reestr_object.t_insp || users.id = reestr_object.g_insp || users.id = reestr_object.ti_insp')
			->joinLeftTable('spr_branch as spr_branch', 'spr_branch.id = reestr_subject.spr_branch')
			->joinLeftTable('spr_podrazdelenie as spr_podrazdelenie', 'spr_podrazdelenie.id = reestr_subject.spr_podrazdelenie')
			->joinLeftTable('spr_otdel as spr_otdel', 'spr_otdel.id = reestr_subject.spr_otdel')
			->where('users.spr_cod_branch', $spr_branch)
            ->groupBy('reestr_subject.id', 'ASC')
			->orderBy('reestr_subject.name', 'ASC')
            ->sql();
		...
		$sql = $this->queryBuilder->dropIndex('reestr_subject_name', 'reestr_subject');
		$sql = $this->queryBuilder->dropIndex('reestr_object_name', 'reestr_object');
		$sql = $this->queryBuilder->dropIndex('users_name', 'users');
		$sql = $this->queryBuilder->dropIndex('spr_branch_name', 'spr_branch');
		$sql = $this->queryBuilder->dropIndex('spr_podrazdelenie_name', 'spr_podrazdelenie');
		$sql = $this->queryBuilder->dropIndex('spr_otdel_name', 'spr_otdel');
		$sql = $this->queryBuilder->sql();
		$this->db->query($sql);		
...
/** Потребители заданного МРО */	
	...
	public function getSubjectByGroup($spr_otdel)
    {
	    ...
	    $sql = $this->queryBuilder->select('reestr_subject.id AS id, COUNT(DISTINCT reestr_object.id) AS count_objects, reestr_subject.name AS name, reestr_subject.num_case_s AS num_case_s, reestr_object.id AS object_id, reestr_object.name AS object_name, spr_branch.sokr_name AS spr_branch_name, spr_podrazdelenie.sokr_name AS spr_name_podrazd, spr_otdel.sokr_name AS spr_name_otdel, reestr_subject.id_unp AS id_unp, reestr_subject.id_ind_pers AS id_ind_pers, SUM(reestr_object.elektro_is) AS sum_objects_el, SUM(reestr_object.t_is) AS sum_objects_t, SUM(reestr_object.ti_is) AS sum_objects_ti, SUM(reestr_object.gaz_is) AS sum_objects_gaz')
            ->from('reestr_subject')
			->joinLeftTable('reestr_object', 'reestr_subject.id = reestr_object.id_reestr_subject')
			->joinLeftTable('users', 'users.id = reestr_object.e_insp || users.id = reestr_object.g_insp || users.id = reestr_object.t_insp || users.id = reestr_object.ti_insp')
			/*->joinLeftTable('users as users_t', 'users_t.id = reestr_object.t_insp')
			->joinLeftTable('users as users_g', 'users_g.id = reestr_object.g_insp')*/
			->joinLeftTable('spr_branch as spr_branch', 'spr_branch.id = reestr_subject.spr_branch')
			->joinLeftTable('spr_podrazdelenie as spr_podrazdelenie', 'spr_podrazdelenie.id = reestr_subject.spr_podrazdelenie')
			->joinLeftTable('spr_otdel as spr_otdel', 'spr_otdel.id = reestr_subject.spr_otdel')
			->where('users.spr_cod_otd', $spr_otdel)
		...
		/*if($inspection_type == 1 && $access_level == 2){
				$sql = $this->queryBuilder->select('reestr_subject.id AS id, COUNT(reestr_object.id) AS count_objects, reestr_subject.name AS name, reestr_subject.num_case_s AS num_case_s, reestr_object.id AS object_id, reestr_object.name AS object_name, users_t.id AS users_t_id, users_t.name AS users_t_name, spr_branch.sokr_name AS spr_branch_name, spr_podrazdelenie.sokr_name AS spr_name_podrazd, spr_otdel.sokr_name AS spr_name_otdel, reestr_subject.id_unp AS id_unp, reestr_subject.id_ind_pers AS id_ind_pers, SUM(reestr_object.elektro_is) AS sum_objects_el, SUM(reestr_object.t_is) AS sum_objects_t, SUM(reestr_object.ti_is) AS sum_objects_ti, SUM(reestr_object.gaz_is) AS sum_objects_gaz')
							->from('reestr_subject')
							->joinLeftTable('reestr_object', 'reestr_subject.id = reestr_object.id_reestr_subject')
							->joinLeftTable('users as users_t', 'users_t.id = reestr_object.t_insp')
							->joinLeftTable('spr_branch as spr_branch', 'spr_branch.id = reestr_subject.spr_branch')
							->joinLeftTable('spr_podrazdelenie as spr_podrazdelenie', 'spr_podrazdelenie.id = reestr_subject.spr_podrazdelenie')
							->joinLeftTable('spr_otdel as spr_otdel', 'spr_otdel.id = reestr_subject.spr_otdel')
							->where('users_t.spr_cod_otd', $spr_otdel)
							->groupBy('reestr_subject.id', 'ASC')
							->orderBy('reestr_subject.name', 'ASC')
							->sql();
							
		}elseif($inspection_type == 2  && $access_level == 2){
				$sql = $this->queryBuilder->select('reestr_subject.id AS id, COUNT(reestr_object.id) AS count_objects, reestr_subject.name AS name, reestr_subject.num_case_s AS num_case_s, reestr_object.id AS object_id, reestr_object.name AS object_name, users_g.id AS users_g_id, users_g.name AS users_g_name, spr_branch.sokr_name AS spr_branch_name, spr_podrazdelenie.sokr_name AS spr_name_podrazd, spr_otdel.sokr_name AS spr_name_otdel, reestr_subject.id_unp AS id_unp, reestr_subject.id_ind_pers AS id_ind_pers, SUM(reestr_object.elektro_is) AS sum_objects_el, SUM(reestr_object.t_is) AS sum_objects_t, SUM(reestr_object.ti_is) AS sum_objects_ti, SUM(reestr_object.gaz_is) AS sum_objects_gaz')
							->from('reestr_subject')
							->joinLeftTable('reestr_object', 'reestr_subject.id = reestr_object.id_reestr_subject')
							->joinLeftTable('users as users_g', 'users_g.id = reestr_object.g_insp')
							->joinLeftTable('spr_branch as spr_branch', 'spr_branch.id = reestr_subject.spr_branch')
	...
	public function getSubjectByUser($id_user, $arm_group)
    {
			...
			$sql = $this->queryBuilder->select('reestr_subject.id AS id, reestr_subject.name AS name, reestr_subject.num_case_s AS num_case_s, COUNT(DISTINCT reestr_object.id) AS count_objects, reestr_object.id AS object_id, reestr_object.name AS object_name, spr_branch.sokr_name AS spr_branch_name, spr_podrazdelenie.sokr_name AS spr_name_podrazd, spr_otdel.sokr_name AS spr_name_otdel, reestr_subject.id_unp AS id_unp, reestr_subject.id_ind_pers AS id_ind_pers, SUM(reestr_object.elektro_is) AS sum_objects_el, SUM(reestr_object.t_is) AS sum_objects_t, SUM(reestr_object.ti_is) AS sum_objects_ti, SUM(reestr_object.gaz_is) AS sum_objects_gaz')
				...
				if($arm_group == 1){
					$sql = $this->queryBuilder->where('reestr_object.t_insp', $id_user);
					$sql = $this->queryBuilder->orWhere('reestr_object.ti_insp', $id_user);
				}elseif($arm_group == 2){
					$sql = $this->queryBuilder->where('reestr_object.g_insp', $id_user);
				}elseif($arm_group == 3){
					$sql = $this->queryBuilder->where('reestr_object.e_insp', $id_user);
				}				
	...
	public function getSubjectByInspectionType($params=[])
    {
		$sql = $this->queryBuilder->select('reestr_subject.id AS id, reestr_subject.name AS name, reestr_subject.num_case_s AS num_case_s, COUNT(reestr_object.id) AS count_objects, reestr_object.id AS object_id, reestr_object.name AS object_name, spr_branch.sokr_name AS spr_branch_name, spr_podrazdelenie.sokr_name AS spr_name_podrazd, spr_otdel.sokr_name AS spr_name_otdel, reestr_subject.id_unp AS id_unp, reestr_subject.id_ind_pers AS id_ind_pers')
			...
			if($params['id_user'] > 0){
			...
			}elseif($params['spr_otdel'] > 0){
				$sql = $this->queryBuilder->where('users_e.spr_cod_otd', $params['spr_cod_podrazd']);
				$sql = $this->queryBuilder->orWhere('users_t.spr_cod_otd', $params['spr_cod_podrazd']);
				$sql = $this->queryBuilder->orWhere('users_ti.spr_cod_otd', $params['spr_cod_podrazd']);
				$sql = $this->queryBuilder->orWhere('users_g.spr_cod_otd', $params['spr_cod_podrazd']);
			}elseif($params['spr_cod_podrazd'] > 0){
				$sql = $this->queryBuilder->where('users_e.spr_cod_podrazd', $params['spr_cod_branch']);
				$sql = $this->queryBuilder->orWhere('users_t.spr_cod_podrazd', $params['spr_cod_branch']);
				$sql = $this->queryBuilder->orWhere('users_ti.spr_cod_podrazd', $params['spr_cod_branch']);
				$sql = $this->queryBuilder->orWhere('users_g.spr_cod_podrazd', $params['spr_cod_branch']);
			}elseif($params['spr_cod_branch'] > 0){
				...
				$sql = $this->queryBuilder->orWhere('users_ti.spr_cod_branch', $params['spr_cod_branch']);
...
//print_r($sql);
	...
	public function getSubjectByName($name, $params =[])
    {
        $sql = $this->queryBuilder->select('reestr_subject.id, reestr_subject.name AS reestr_subject_name, reestr_subject.id_unp AS reestr_subject_id_unp, reestr_subject.id_ind_pers AS reestr_subject_id_ind_pers, reestr_subject.place_address_index, reestr_subject.place_address_region, reestr_subject.place_address_district, reestr_subject.place_address_city, reestr_subject.place_address_city_zone, reestr_subject.place_address_street, reestr_subject.place_address_building, reestr_subject.place_address_flat, spr_region.name AS spr_region_name, spr_district.name AS spr_district_name, spr_city.name AS spr_city_name, spr_type_city.sokr_name AS spr_type_city_sokr_name, spr_type_street.sokr_name AS spr_type_street_sokr_name, spr_city_zone.name AS spr_city_zone_name, spr_city.key_region AS spr_city_key_region')
			...
			->joinLeftTable('spr_type_city', 'spr_type_city.id = reestr_subject.place_address_city_type')
			->joinLeftTable('spr_type_street', 'spr_type_street.id = reestr_subject.place_address_street_type')
			->joinLeftTable('spr_city_zone', 'spr_city_zone.id = reestr_subject.place_address_city_zone')
    ...
    {
        $sql = $this->queryBuilder->select('reestr_subject.id, reestr_subject.otv_e3 AS reestr_subject_otv_e3, reestr_personal.id AS reestr_personal_id, reestr_personal.id_reestr_unp AS reestr_personal_id_reestr_unp, reestr_personal.firstname AS reestr_personal_firstname, reestr_personal.secondname AS reestr_personal_secondname, reestr_personal.lastname AS reestr_personal_lastname, reestr_personal.post AS reestr_personal_post, reestr_unp.id AS reestr_unp_id, reestr_unp.name_short AS reestr_unp_name_short, test_book_e.id AS test_book_e_id, test_book_e.person_id AS person_id, test_book_e.el_group AS el_group, test_book_e.test_validity AS test_book_e_test_validity')
            ->from('reestr_subject')
			->joinLeftTable('reestr_personal', 'reestr_personal.id = reestr_subject.otv_e3')
			->joinLeftTable('reestr_unp', 'reestr_unp.id = reestr_personal.id_reestr_unp')
			->joinLeftTable('test_book_e', 'test_book_e.person_id = reestr_subject.otv_e3')
			->where('reestr_subject.otv_e3', $id)
	...
	public function getPersInfoByID_t($id)
    {
        $sql = $this->queryBuilder->select('reestr_subject.id, reestr_subject.otv_t3 AS reestr_subject_otv_t3, reestr_personal.id AS reestr_personal_id, reestr_personal.id_reestr_unp AS reestr_personal_id_reestr_unp, reestr_personal.firstname AS reestr_personal_firstname, reestr_personal.secondname AS reestr_personal_secondname, reestr_personal.lastname AS reestr_personal_lastname, reestr_personal.post AS reestr_personal_post, reestr_unp.id AS reestr_unp_id, reestr_unp.name_short AS reestr_unp_name_short')
            ->from('reestr_subject')
			->joinLeftTable('reestr_personal', 'reestr_personal.id = reestr_subject.otv_t3')
			->joinLeftTable('reestr_unp', 'reestr_unp.id = reestr_personal.id_reestr_unp')
			->where('reestr_subject.otv_t3', $id)
            ->sql();
        return $this->db->query($sql, $this->queryBuilder->values);
    }

	public function getPersInfoByID1($id)
    {
        $sql = $this->queryBuilder->select('reestr_subject.id, reestr_subject.otv_e1 AS reestr_subject_otv_e1, reestr_personal.id AS reestr_personal_id, reestr_personal.id_reestr_unp AS reestr_personal_id_reestr_unp, reestr_personal.firstname AS reestr_personal_firstname, reestr_personal.secondname AS reestr_personal_secondname, reestr_personal.lastname AS reestr_personal_lastname, reestr_personal.post AS reestr_personal_post, reestr_unp.id AS reestr_unp_id, reestr_unp.name_short AS reestr_unp_name_short, test_book_e.id AS test_book_e_id, test_book_e.person_id AS person_id, test_book_e.el_group AS el_group, test_book_e.test_validity AS test_book_e_test_validity')
            ->from('reestr_subject')
			->joinLeftTable('reestr_personal', 'reestr_personal.id = reestr_subject.otv_e1')
			->joinLeftTable('reestr_unp', 'reestr_unp.id = reestr_personal.id_reestr_unp')
			->joinLeftTable('test_book_e', 'test_book_e.person_id = reestr_subject.otv_e1')
			->where('reestr_subject.otv_e1', $id)
			->orderBy('test_book_e.id', 'DESC')
			->LIMIT(1)
            ->sql();
        return $this->db->query($sql, $this->queryBuilder->values);
	...
	public function getPersInfoByID1_t($id)
    {
        $sql = $this->queryBuilder->select('reestr_subject.id, reestr_subject.otv_t1 AS reestr_subject_otv_t1, reestr_personal.id AS reestr_personal_id, reestr_personal.id_reestr_unp AS reestr_personal_id_reestr_unp, reestr_personal.firstname AS reestr_personal_firstname, reestr_personal.secondname AS reestr_personal_secondname, reestr_personal.lastname AS reestr_personal_lastname, reestr_personal.post AS reestr_personal_post, reestr_unp.id AS reestr_unp_id, reestr_unp.name_short AS reestr_unp_name_short')
            ->from('reestr_subject')
			->joinLeftTable('reestr_personal', 'reestr_personal.id = reestr_subject.otv_t1')
			->joinLeftTable('reestr_unp', 'reestr_unp.id = reestr_personal.id_reestr_unp')
			->where('reestr_subject.otv_t1', $id)
            ->sql();
        return $this->db->query($sql, $this->queryBuilder->values);
    }

	public function getPersInfoByID2($id)
    {
        $sql = $this->queryBuilder->select('reestr_subject.id, reestr_subject.otv_e2 AS reestr_subject_otv_e2, reestr_personal.id AS reestr_personal_id, reestr_personal.id_reestr_unp AS reestr_personal_id_reestr_unp, reestr_personal.firstname AS reestr_personal_firstname, reestr_personal.secondname AS reestr_personal_secondname, reestr_personal.lastname AS reestr_personal_lastname, reestr_personal.post AS reestr_personal_post, reestr_unp.id AS reestr_unp_id, reestr_unp.name_short AS reestr_unp_name_short, test_book_e.id AS test_book_e_id, test_book_e.person_id AS person_id, test_book_e.el_group AS el_group, test_book_e.test_validity AS test_book_e_test_validity')
            ->from('reestr_subject')
			->joinLeftTable('reestr_personal', 'reestr_personal.id = reestr_subject.otv_e2')
			->joinLeftTable('reestr_unp', 'reestr_unp.id = reestr_personal.id_reestr_unp')
			->joinLeftTable('test_book_e', 'test_book_e.person_id = reestr_subject.otv_e2')
			->where('reestr_subject.otv_e2', $id)
			->orderBy('test_book_e.id', 'DESC')
			->LIMIT(1)
            ->sql();
        return $this->db->query($sql, $this->queryBuilder->values);
	...
	public function getPersInfoByID2_t($id)
    {
        $sql = $this->queryBuilder->select('reestr_subject.id, reestr_subject.otv_t2 AS reestr_subject_otv_t2, reestr_personal.id AS reestr_personal_id, reestr_personal.id_reestr_unp AS reestr_personal_id_reestr_unp, reestr_personal.firstname AS reestr_personal_firstname, reestr_personal.secondname AS reestr_personal_secondname, reestr_personal.lastname AS reestr_personal_lastname, reestr_personal.post AS reestr_personal_post, reestr_unp.id AS reestr_unp_id, reestr_unp.name_short AS reestr_unp_name_short')
            ->from('reestr_subject')
			->joinLeftTable('reestr_personal', 'reestr_personal.id = reestr_subject.otv_t2')
			->joinLeftTable('reestr_unp', 'reestr_unp.id = reestr_personal.id_reestr_unp')
			->where('reestr_subject.otv_t2', $id)
            ->sql();
        return $this->db->query($sql, $this->queryBuilder->values);
    }

	public function getNameTypeOtv($id)
    {
        $sql = $this->queryBuilder->select('spr_otv_vibor.id AS spr_otv_vibor_id, spr_otv_vibor.name AS spr_otv_vibor_name')
            ->from('spr_otv_vibor')
			//->joinLeftTable('spr_otv_vibor', 'spr_otv_vibor.id = reestr_subject.otv_type_e')
			->where('spr_otv_vibor.id', $id)
            ->sql();
        return $this->db->query($sql, $this->queryBuilder->values);
    }
	public function getNameTypeOtvT($id)
    {
        $sql = $this->queryBuilder->select('spr_otv_vibor.id AS spr_otv_vibor_id, spr_otv_vibor.name AS spr_otv_vibor_name')
            ->from('spr_otv_vibor')
			//->joinLeftTable('spr_otv_vibor', 'spr_otv_vibor.id = reestr_subject.otv_type_e')
...
//print_r($params);
		...
		if(strlen($params['otv_e3'])>0){
			$subject->setOtv_e3($params['otv_e3']);
		}		
		if(strlen($params['order_num_e3'])>0){
			$subject->setOrder_num_e3($params['order_num_e3']);
		}		
		if(strlen($params['order_data_e3'])>0){
			$subject->setOrder_data_e3($params['order_data_e3']);
		}		
		if(strlen($params['dog_num_e3'])>0){
			$subject->setDog_num_e3($params['dog_num_e3']);
		}		
		if(strlen($params['dog_data_e3'])>0){
			$subject->setDog_data_e3($params['dog_data_e3']);
		}		
		if(strlen($params['dog_data_cont_e3'])>0){
			$subject->setDog_data_cont_e3($params['dog_data_cont_e3']);
		}	
		...
		if(strlen($params['otv_t1'])>0){
			$subject->setOtv_t1($params['otv_t1']);
		}
		if(strlen($params['otv_t2'])>0){
			$subject->setOtv_t2($params['otv_t2']);
		}		
		if(strlen($params['order_num_t1'])>0){
			$subject->setOrder_num_t1($params['order_num_t1']);
		}
		if(strlen($params['order_num_t2'])>0){
			$subject->setOrder_num_t2($params['order_num_t2']);
		}		
		if(strlen($params['order_data_t1'])>0){
			$subject->setOrder_data_t1($params['order_data_t1']);
		}
		if(strlen($params['order_data_t2'])>0){
			$subject->setOrder_data_t2($params['order_data_t2']);
		}		
		
		if(strlen($params['ins_data_t'])>0){
			$subject->setIns_data_t($params['ins_data_t']);
		}		

		if(strlen($params['otv_t3'])>0){
			$subject->setOtv_t3($params['otv_t3']);
		}		
		if(strlen($params['order_num_t3'])>0){
			$subject->setOrder_num_t3($params['order_num_t3']);
		}		
		if(strlen($params['order_data_t3'])>0){
			$subject->setOrder_data_t3($params['order_data_t3']);
		}		
		if(strlen($params['dog_num_t3'])>0){
			$subject->setDog_num_t3($params['dog_num_t3']);
		}		
		if(strlen($params['dog_data_t3'])>0){
			$subject->setDog_data_t3($params['dog_data_t3']);
		}		
		if(strlen($params['dog_data_cont_t3'])>0){
			$subject->setDog_data_cont_t3($params['dog_data_cont_t3']);
		}			
		/*
		...
		if(strlen($params['sbj_note'])>0){
			$subject->setSbj_note($params['sbj_note']);
		}
		if(strlen($params['email'])>0){
			$subject->setEmail($params['email']);
		}
...
print_r($params);
        if (isset($params['subject_id'])) {
				...
				if(isset($params['otv_e3'])){
					$subject->setOtv_e3($params['otv_e3']);
				}				
				if(isset($params['dog_data_cont_e3'])){
					$subject->setDog_data_cont_e3($params['dog_data_cont_e3']);
				}				
				if(isset($params['order_num_e3'])){
					$subject->setOrder_num_e3($params['order_num_e3']);
				}				
				if(isset($params['order_data_e3'])){
					$subject->setOrder_data_e3($params['order_data_e3']);
				}				
				if(isset($params['dog_num_e3'])){
					$subject->setDog_num_e3($params['dog_num_e3']);
				}
				if(isset($params['dog_data_e3'])){
					$subject->setDog_data_e3($params['dog_data_e3']);
				}				
				...
				if(isset($params['otv_t1'])){
					$subject->setOtv_t1($params['otv_t1']);
				}
				if(isset($params['otv_t2'])){
					$subject->setOtv_t2($params['otv_t2']);
				}
				if(isset($params['order_num_t1'])){
					$subject->setOrder_num_t1($params['order_num_t1']);
				}
				if(isset($params['order_num_t2'])){
					$subject->setOrder_num_t2($params['order_num_t2']);
				}		
				if(isset($params['order_data_t1'])){
					$subject->setOrder_data_t1($params['order_data_t1']);
				}
				if(isset($params['order_data_t2'])){
					$subject->setOrder_data_t2($params['order_data_t2']);
				}		
				if(isset($params['ins_data_t'])){
					$subject->setIns_data_t($params['ins_data_t']);
				}	

				if(isset($params['otv_t3'])){
					$subject->setOtv_t3($params['otv_t3']);
				}				
				if(isset($params['dog_data_cont_t3'])){
					$subject->setDog_data_cont_t3($params['dog_data_cont_t3']);
				}				
				if(isset($params['order_num_t3'])){
					$subject->setOrder_num_t3($params['order_num_t3']);
				}				
				if(isset($params['order_data_t3'])){
					$subject->setOrder_data_t3($params['order_data_t3']);
				}				
				if(isset($params['dog_num_t3'])){
					$subject->setDog_num_t3($params['dog_num_t3']);
				}
				if(isset($params['dog_data_t3'])){
					$subject->setDog_data_t3($params['dog_data_t3']);
				}				
				/*if(isset($params['otv_type_t'])){
					$subject->setOtv_type_t($params['otv_type_t']);
	...
	public function getSubjectsByFilter($params)
	{
		...
		$sql = $this->queryBuilder->select('reestr_subject.id AS id, reestr_subject.name AS name, reestr_subject.num_case_s AS num_case_s, reestr_subject.spr_otdel AS spr_otdel, reestr_subject.spr_branch AS spr_branch, reestr_subject.spr_podrazdelenie AS spr_podrazdelenie, reestr_object.id AS object_id, count(reestr_object.id) AS count_object_id, reestr_object.name AS object_name, spr_branch.sokr_name AS spr_branch_name, spr_podrazdelenie.sokr_name AS spr_name_podrazd, spr_otdel.sokr_name AS spr_name_otdel, spr_region.name AS object_address_region, spr_district.name as object_address_district, spr_city.name as object_address_city, address_street AS object_address_street, address_building AS object_address_building, address_flat AS object_address_flat, num_case_o AS object_num_case_o, reestr_object.e_insp AS e_insp, reestr_object.t_insp AS t_insp, reestr_object.ti_insp AS ti_insp, reestr_object.g_insp AS g_insp, reestr_subject.id_unp AS id_unp, reestr_subject.id_ind_pers AS id_ind_pers, SUM(reestr_object.elektro_is) AS sum_objects_el, SUM(reestr_object.t_is) AS sum_objects_t, SUM(reestr_object.ti_is) AS sum_objects_ti, SUM(reestr_object.gaz_is) AS sum_objects_gaz ')
			...
			if($params['mf_form_num_case_old'] > 0){
				$sql = $this->queryBuilder->where('reestr_subject.id', '%'.$params['mf_form_num_case_old'].'%', 'LIKE');
			}
			...
			if(isset($params['mf_branch_sbj']) && $params['mf_branch_sbj'] > 0){
				$sql = $this->queryBuilder->blockWhere('users_e.spr_cod_branch = '.$params['mf_branch_sbj'].' OR users_t.spr_cod_branch = '.$params['mf_branch_sbj'].' OR users_ti.spr_cod_branch = '.$params['mf_branch_sbj'].' OR users_g.spr_cod_branch = '.$params['mf_branch_sbj']);
			}
			if(isset($params['mf_podrazdelenie_sbj']) && $params['mf_podrazdelenie_sbj'] > 0){
				$sql = $this->queryBuilder->blockWhere('users_e.spr_cod_podrazd = '.$params['mf_podrazdelenie_sbj'].' OR users_t.spr_cod_podrazd = '.$params['mf_podrazdelenie_sbj'].' OR users_ti.spr_cod_podrazd = '.$params['mf_podrazdelenie_sbj'].' OR users_g.spr_cod_podrazd = '.$params['mf_podrazdelenie_sbj']);
			}
			if(isset($params['mf_otdel_sbj']) && $params['mf_otdel_sbj'] > 0){
				$sql = $this->queryBuilder->blockWhere('users_e.spr_cod_otd = '.$params['mf_otdel_sbj'].' OR users_t.spr_cod_otd = '.$params['mf_otdel_sbj'].' OR users_ti.spr_cod_otd = '.$params['mf_otdel_sbj'].' OR users_g.spr_cod_otd = '.$params['mf_otdel_sbj']);
			}
			if(strlen($params['mf_user'])>0){
				$sql = $this->queryBuilder->blockWhere('users_e.fam LIKE "%'.$params['mf_user'].'%" OR users_t.fam LIKE "%'.$params['mf_user'].'%" OR users_ti.fam LIKE "%'.$params['mf_user'].'%" OR users_g.fam LIKE "%'.$params['mf_user'].'%"');
			}
...
//print_r($params);
		...
		->from('reestr_subject')
			...
			if(isset($params['formBranchObject']) && $params['formBranchObject'] > 0){
				$sql = $this->queryBuilder->blockWhereOr('users_e.spr_cod_branch = '.$params['formBranchObject'].' OR users_t.spr_cod_branch = '.$params['formBranchObject'].' OR users_ti.spr_cod_branch = '.$params['formBranchObject'].' OR users_g.spr_cod_branch = '.$params['formBranchObject']);
			}
			if(isset($params['formPodrazdelenieObject']) && $params['formPodrazdelenieObject'] > 0){
				$sql = $this->queryBuilder->blockWhereOr('users_e.spr_cod_podrazd = '.$params['formPodrazdelenieObject'].' OR users_t.spr_cod_podrazd = '.$params['formPodrazdelenieObject'].' OR users_ti.spr_cod_podrazd = '.$params['formPodrazdelenieObject'].' OR users_g.spr_cod_podrazd = '.$params['formPodrazdelenieObject']);
			}
			if(isset($params['formOtdelObject']) && $params['formOtdelObject'] > 0){
				$sql = $this->queryBuilder->blockWhereOr('users_e.spr_cod_otd = '.$params['formOtdelObject'].' OR users_t.spr_cod_otd = '.$params['formOtdelObject'].' OR users_ti.spr_cod_otd = '.$params['formOtdelObject'].' OR users_g.spr_cod_otd = '.$params['formOtdelObject']);
			}
