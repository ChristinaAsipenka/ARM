<?php $this->theme->header(); ?>
	<!-- LOGO БАЗЫ --->	<div class = "logo_units"><span><i class="icon-list"></i></span><p>Журнал ОЛГ</p></div>
    <main>
        <div class="container">
			<div class="sticky_body">
				<div class='top_of_page'>
					...
					<div class="page_title">
						<h5>Реестр ОЛГ</h5>				
						<h3><span><i class="icon-unp">&nbsp</i></span>Журнал прохождения тестирования ответственных лиц за газовое хозяйство</h3>
					</div>
					<div class ='nav_buttons'> 
						<button class="button_filter" id='filterForZurnal_g'><span><i class="icon-filter"></i></span>Фильтр</button>				
					...
					<div id='main_block_filter'>
						...
						<div id='block_for_unp'>
							...
							<form class="form" >
								...
								<div class ='nav_buttons'>
									<button class="button_filter" id='apply_filter_g'><span><i class="icon-check-ok"></i></span>Применить</button>
			...
			<div class='total_check'>
				Всего: <span id='count_record_g'></span>
			</div>
			
			</div>


<?php //print_r($test_book_t);?>
			...
			<table class="main_table">
				...
				<tbody>
					...
					<tr class="item-<?= $zurnal['id'] ?>">
						...
						<td class="list_td">
							<div class="tooltip" >
								<a href="/ARM/examination/zurnal/zurnal_g_edit/<?= $zurnal['person_id'] ?>">
