...
- Fix for Issue [#1505](https://github.com/PHPOffice/PhpSpreadsheet/issues/1505) (TypeError : Argument 4 passed to Library\PhpSpreadsheet\Writer\Xlsx\Worksheet::writeAttributeIf() must be of the type string) [#1525](https://github.com/PHPOffice/PhpSpreadsheet/pull/1525)
...
- Introduction of namespaces for all classes, eg: `PHPExcel_Calculation_Functions` becomes `Library\PhpSpreadsheet\Calculation\Functions`
