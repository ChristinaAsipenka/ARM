...
use Library\PhpSpreadsheet\Chart\Axis;
use Library\PhpSpreadsheet\Chart\DataSeries;
use Library\PhpSpreadsheet\Chart\DataSeriesValues;
use Library\PhpSpreadsheet\Chart\GridLines;
use Library\PhpSpreadsheet\Chart\Layout;
use Library\PhpSpreadsheet\Chart\Legend;
use Library\PhpSpreadsheet\Chart\PlotArea;
use Library\PhpSpreadsheet\Chart\Title;
...
class Chart extends WriterPart
{
     ...
     */
    public function writeChart(\Library\PhpSpreadsheet\Chart\Chart $pChart, $calculateCellValues = true)
    {
     ...
     * @param Axis $yAxis
     */
    private function writePlotArea(XMLWriter $objWriter, \Library\PhpSpreadsheet\Worksheet\Worksheet $pSheet, PlotArea $plotArea, ?Title $xAxisLabel = null, ?Title $yAxisLabel = null, ?Axis $xAxis = null, ?Axis $yAxis = null, ?GridLines $majorGridlines = null, ?GridLines $minorGridlines = null): void
    {
        if ($plotArea === null) {
            return;
        }
     ...
     *
     * @param XMLWriter $objWriter XML Writer
     * @param \Library\PhpSpreadsheet\Chart\Layout $chartLayout Chart layout
     */
