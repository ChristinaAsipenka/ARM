...
use Library\PhpSpreadsheet\Style\ConditionalFormatting\ConditionalDataBar;
use Library\PhpSpreadsheet\Style\ConditionalFormatting\ConditionalFormattingRuleExtension;
use Library\PhpSpreadsheet\Worksheet\AutoFilter\Column;
use Library\PhpSpreadsheet\Worksheet\AutoFilter\Column\Rule;
use Library\PhpSpreadsheet\Worksheet\SheetView;
use Library\PhpSpreadsheet\Worksheet\Worksheet as PhpspreadsheetWorksheet;
...
class Worksheet extends WriterPart
{
    ...
    private function writeCellFormula(XMLWriter $objWriter, string $cellValue, Cell $pCell): void
    {
        ...
        if (is_string($calculatedValue)) {
            if (\Library\PhpSpreadsheet\Calculation\Functions::isError($calculatedValue)) {
    ...
    private function writeDrawings(XMLWriter $objWriter, PhpspreadsheetWorksheet $pSheet, $includeCharts = false): void
    {
        ...
        if (isset($unparsedLoadedData['sheets'][$pSheet->getCodeName()]['drawingOriginalIds'])) {
            ...
            // (! synchronize with \Library\PhpSpreadsheet\Writer\Xlsx\Rels::writeWorksheetRelationships)
