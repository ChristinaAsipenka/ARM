...
class Drawing
{
     ...
     *
     * @param int $pixelValue Value in pixels
     * @param \Library\PhpSpreadsheet\Style\Font $pDefaultFont Default font of the workbook
     *
     * @return float|int Value in cell dimension
     */
    public static function pixelsToCellDimension($pixelValue, \Library\PhpSpreadsheet\Style\Font $pDefaultFont)
    {
        // Font name and size
     ...
     * @return int Value in pixels
     */
    public static function cellDimensionToPixels($cellWidth, \Library\PhpSpreadsheet\Style\Font $pDefaultFont)
    {
        // Font name and size
        $name = $pDefaultFont->getName();
        $size = $pDefaultFont->getSize();
