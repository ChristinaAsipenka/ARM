...
use Library\PhpSpreadsheet\Cell\DataValidation;
use Library\PhpSpreadsheet\Exception as PhpSpreadsheetException;
use Library\PhpSpreadsheet\NamedRange;
use Library\PhpSpreadsheet\Reader\Xls\Style\CellFont;
use Library\PhpSpreadsheet\RichText\RichText;
use Library\PhpSpreadsheet\Shared\CodePage;
use Library\PhpSpreadsheet\Shared\Date;
use Library\PhpSpreadsheet\Shared\Escher;
use Library\PhpSpreadsheet\Shared\Escher\DggContainer\BstoreContainer\BSE;
use Library\PhpSpreadsheet\Shared\File;
use Library\PhpSpreadsheet\Shared\OLE;
use Library\PhpSpreadsheet\Shared\OLERead;
use Library\PhpSpreadsheet\Shared\StringHelper;
use Library\PhpSpreadsheet\Spreadsheet;
use Library\PhpSpreadsheet\Style\Alignment;
        ...
        foreach ($this->sheets as $sheet) {
            ...
            foreach ($this->objs as $n => $obj) {
                ...
                if (isset($allSpContainers[$n + 1]) && is_object($allSpContainers[$n + 1])) {
                    ...
                    $width = \Library\PhpSpreadsheet\Shared\Xls::getDistanceX($this->phpSheet, $startColumn, $startOffsetX, $endColumn, $endOffsetX);
                    $height = \Library\PhpSpreadsheet\Shared\Xls::getDistanceY($this->phpSheet, $startRow, $startOffsetY, $endRow, $endOffsetY);

                    // calculate offsetX and offsetY of the shape
                    $offsetX = $startOffsetX * \Library\PhpSpreadsheet\Shared\Xls::sizeCol($this->phpSheet, $startColumn) / 1024;
                    $offsetY = $startOffsetY * \Library\PhpSpreadsheet\Shared\Xls::sizeRow($this->phpSheet, $startRow) / 256;
