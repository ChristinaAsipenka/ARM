<div id="openModalRespPers" class="modalDialog">
	...
	<div class="form-group type_otv">
		<label for="formTitle" class='label_subject'>Тип ответственного:</label>
			...
			<select class="form-controls" name="type_otv" id="type_otv" onclick="resp_pers.search_hide_show(this.value)">
	...
	<div id  = "otv_sob1">
		<div class="form-group type_otv" id="dis_name_otv_sob1">
			<p class='label_subject' id = "l1"></p>
				<select class="form-controls" name="name_otv_sob1" id="name_otv_sob1" onclick="resp_pers.num_dog_otv1_hide(this.value)">
	...
	<div id  = "otv_sob2">
		<div class="form-group type_otv" id="dis_name_otv_sob2">
			<p class='label_subject'  id = "l2"></p>
				<select class="form-controls" name="name_otv_sob2" id="name_otv_sob2" onclick="resp_pers.num_dog_otv2_hide(this.value)">
					<option value='0'>Выберите ответственное лицо</option>
	...
	<div id = "otv_stor">
		<div class="form-group type_otv">																				
			<label for = 'search' class='label_subject'>Ответственное лицо:</label>
				...
				<button onclick = "modalWindow.openModal('openModalUNP')" id='unp_resp' class="shine-button">Выбрать из реестра юридических лиц</button>
		</div>
...
<!-------------------------------------------------------------- блок кнопок ------------------------------------------------------------------------->
	<div class="group otv_button">
		<div class="group-button" id="but_otv_add">
			<button type="submit" id="otv_add" class="btn btn-primary" onclick="resp_pers.insert_otv()">Добавить</button>
