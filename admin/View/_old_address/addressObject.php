...
<div class="form-group">
	<label for="formTitle" class="label_subject">Город/населенный пункт:</label>
		...
		<select class="form-controls" name="spr_type_city_object" id="spr_type_city_object">
...
<div class="form-group">
	<label for="formTitle" class="label_subject">Улица/проспект:</label>
		<select class="form-controls" name="spr_type_street_object" id="spr_type_street_object">
		<option value='0'>---</option>
			
				<?php foreach($spr_type_street as $one_spr_type_street):
			
					if(isset($subject['place_address_street_type'])){
