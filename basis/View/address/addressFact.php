...
<div class="form-group">
	...
	<select class="form-controls form-small" name="spr_type_city_place" id="spr_type_city_place">
...
<div class="form-group">
	...
	<select class="form-controls form-small" name="spr_type_street_place" id="spr_type_street_place">
		<option value='0'>---</option>
