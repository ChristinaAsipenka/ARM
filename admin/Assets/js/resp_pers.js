...
var resp_pers = {
    ...
    add: function() {
		...
		if(error == 0){		
		  $.ajax({
				url: '/ARM/responsible_persons/add/',
				...
				success: function(result){
				 ...
				 //window.location = '/ARM/responsible_persons/';
				 window.history.back();
    ...
    update: function() {
		...
		if(error == 0){		
			...
			$.ajax({
				url: '/ARM/responsible_persons/update/',
				type: this.ajaxMethod,
				data: formData,
				cache: false,
				processData: false,
				...
				success: function(result){
					alert('Данные сохранены');
					//window.location = '/ARM/responsible_persons/list/'+$('#formUnpId').val();
					window.history.back();
				  //console.log(result);
				}
			});
	...
	remove: function(itemId) {
	    ...
	    if (itemId < 1) {
			...
			$.ajax({
				url: '/ARM/responsible_persons/removeItem/',
				type: this.ajaxMethod,
				data: formData,
				cache: false,
				processData: false,
	...
	RespPersInfo: function(resppersId){
		...
		$.ajax({
				url: '/ARM/responsible_persons/info/'+resppersId,
				type: this.ajaxMethod,
				data: formData,
				cache: false,
				processData: false,
	...
	search_hide_show: function(value) {
		if(value == 1){
			...
			var formData = new FormData();
				...
				$.ajax({
					url: '/ARM/responsible_persons/ListRespPers/',
					type: this.ajaxMethod,
					data: formData,
					cache: false,
					processData: false,
