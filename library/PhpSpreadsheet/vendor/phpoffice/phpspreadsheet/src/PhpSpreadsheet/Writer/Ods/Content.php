...
namespace Library\PhpSpreadsheet\Writer\Ods;
...
use Library\PhpSpreadsheet\Worksheet\Row;
use Library\PhpSpreadsheet\Worksheet\Worksheet;
use Library\PhpSpreadsheet\Writer\Exception;
use Library\PhpSpreadsheet\Writer\Ods;
use Library\PhpSpreadsheet\Writer\Ods\Cell\Comment;
use Library\PhpSpreadsheet\Writer\Ods\Cell\Style;
...
class Content extends WriterPart
{
    ...
    private function writeCells(XMLWriter $objWriter, Row $row): void
    {
        ...
        while ($cells->valid()) {
            /** @var \Library\PhpSpreadsheet\Cell\Cell $cell */
            $cell = $cells->current();
