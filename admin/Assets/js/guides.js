var guides = {
	...
	add_type_street: function() {
      ...
      $.ajax({
            url: '/ARM/guides/add_type_street/',
	...
	add_type_property: function() {
      ...
      $.ajax({
            url: '/ARM/guides/add_type_property/',
            type: this.ajaxMethod,
            data: formData,
            cache: false,
            processData: false,
	...
	add_shift_of_work: function() {
      ...
      $.ajax({
            url: '/ARM/guides/add_shift_of_work/',
            type: this.ajaxMethod,
            data: formData,
            cache: false,
            processData: false,
	...
	add_ot_type_heat_source: function() {
      ...
      $.ajax({
            url: '/ARM/guides/add_ot_type_heat_source/',
            type: this.ajaxMethod,
            data: formData,
            cache: false,
            processData: false,
	...
	add_ot_systemheat_water: function() {
      ...
      $.ajax({
            url: '/ARM/guides/add_ot_systemheat_water/',
            type: this.ajaxMethod,
            data: formData,
            cache: false,
            processData: false,
	...
	add_ot_systemheat_dependent: function() {
      ...
      $.ajax({
            url: '/ARM/guides/add_ot_systemheat_dependent/',
            type: this.ajaxMethod,
            data: formData,
            cache: false,
            processData: false,
	...
	add_ot_heatnet_type_underground: function() {
      ...
      $.ajax({
            url: '/ARM/guides/add_ot_heatnet_type_underground/',
            type: this.ajaxMethod,
            data: formData,
            cache: false,
            processData: false,
	...
	add_ot_gvs_open: function() {
      ...
      $.ajax({
            url: '/ARM/guides/add_ot_gvs_open/',
            type: this.ajaxMethod,
            data: formData,
            cache: false,
            processData: false,
	...
	add_oti_boiler_type: function() {
      ...
      $.ajax({
            url: '/ARM/guides/add_oti_boiler_type/',
            type: this.ajaxMethod,
            data: formData,
            cache: false,
            processData: false,
	...
	add_ot_type_izol: function() {
      ...
      $.ajax({
            url: '/ARM/guides/add_ot_type_izol/',
            type: this.ajaxMethod,
            data: formData,
            cache: false,
            processData: false,
...
//console.log(result);
	...
	add_ot_type_ot_pribor: function() {
      ...
      $.ajax({
            url: '/ARM/guides/add_ot_type_ot_pribor/',
            type: this.ajaxMethod,
            data: formData,
            cache: false,
            processData: false,
	...
	add_ot_type_razvodka: function() {
      ...
      $.ajax({
            url: '/ARM/guides/add_ot_type_razvodka/',
            type: this.ajaxMethod,
            data: formData,
            cache: false,
            processData: false,
...
//console.log(result);
	...
	add_ot_nazn_sar: function() {
      ...
      $.ajax({
            url: '/ARM/guides/add_ot_nazn_sar/',
            type: this.ajaxMethod,
            data: formData,
            cache: false,
            processData: false,
...
//console.log(result);
	...
	add_og_type_home: function() {
      ...
      $.ajax({
            url: '/ARM/guides/add_og_type_home/',
            type: this.ajaxMethod,
            data: formData,
            cache: false,
            processData: false,
	...
	add_oe_energy_type: function() {
      ...
      $.ajax({
            url: '/ARM/guides/add_oe_energy_type/',
            type: this.ajaxMethod,
            data: formData,
            cache: false,
            processData: false,
	...
	add_kind_of_activity: function() {
      ...
      $.ajax({
            url: '/ARM/guides/add_kind_of_activity/',
            type: this.ajaxMethod,
            data: formData,
            cache: false,
            processData: false,
	...
	add_ot_heatnet_type_iso: function() {
      ...
      $.ajax({
            url: '/ARM/guides/add_ot_heatnet_type_iso/',
            type: this.ajaxMethod,
            data: formData,
            cache: false,
            processData: false,
	...
	add_ot_functions: function() {
      ...
      $.ajax({
            url: '/ARM/guides/add_ot_functions/',
            type: this.ajaxMethod,
            data: formData,
            cache: false,
            processData: false,
	...
	add_oti_type_fuel: function() {
      ...
      $.ajax({
            url: '/ARM/guides/add_oti_type_fuel/',
            type: this.ajaxMethod,
            data: formData,
            cache: false,
            processData: false,
	...
	add_oti_type_fuel_rezerv: function() {
      ...
      $.ajax({
            url: '/ARM/guides/add_oti_type_fuel_rezerv/',
            type: this.ajaxMethod,
            data: formData,
            cache: false,
            processData: false,
	...
	add_og_type_gaz: function() {
      ...
      $.ajax({
            url: '/ARM/guides/add_og_type_gaz/',
            type: this.ajaxMethod,
            data: formData,
            cache: false,
            processData: false,
	...
	add_og_flue_mater: function() {
      ...
      $.ajax({
            url: '/ARM/guides/add_og_flue_mater/',
            type: this.ajaxMethod,
            data: formData,
            cache: false,
            processData: false,
	...
	add_og_device_type: function() {
      ...
      $.ajax({
            url: '/ARM/guides/add_og_device_type/',
            type: this.ajaxMethod,
            data: formData,
            cache: false,
            processData: false,
	...
	add_oe_klvl_volt: function() {
      ...
      $.ajax({
            url: '/ARM/guides/add_oe_klvl_volt/',
            type: this.ajaxMethod,
            data: formData,
            cache: false,
            processData: false,
	...
	add_oe_klvl_type: function() {
      ...
      $.ajax({
            url: '/ARM/guides/add_oe_klvl_type/',
            type: this.ajaxMethod,
            data: formData,
            cache: false,
            processData: false,
	...
	add_district: function() {
		...
		var id_edit = $('input[name="id_district"]').val();
			...
			/*	formData.append('id', id_edit);				
				...
				var err_text = "";		
				if(($('#district_name').val()).length > 0 && ($('#region_by_district').val()).length > 0 ){
					formData.append('id', id_edit);				
					formData.append('name', $('#district_name').val());
					formData.append('idSprRegion', $('#region_by_district').val());
					formData.append('reg_name', $('#region_by_district option:selected').text());
      ...
      $.ajax({
            ...
            success: function(result){
			  ...
			  $.ajax({
					url: '/ARM/guides/add_adminBydistrict/',
					type: this.ajaxMethod,
					data: formData,
					cache: false,
					processData: false,
	...
	add_department: function() {
		...
		var id_edit = $('input[name="id_department"]').val();
				...
				var err_text = "";		
				if(($('#department_name').val()).length > 0 && ($('#type_by_department').val()).length > 0){
					formData.append('id', id_edit);				
					formData.append('name', $('#department_name').val());
					formData.append('idSprDepartment', $('#type_by_department').val());
					formData.append('type_prop_name', $('#type_by_department option:selected').text());
	...
	add_city: function() {
		...
		var id_edit = $('input[name="id_city"]').val();
				...
				/*formData.append('id', id_edit);				
				formData.append('name', $('#city_name').val());
				formData.append('id_spr_region', $('#formRegionFact').val());
				formData.append('region_by_city', $('#formRegionFact option:selected').text());	

				if($('#formDistrictFact').val() > 0){
					formData.append('id_spr_district', $('#formDistrictFact').val());
				}else{
					formData.append('id_spr_district', $('#openModalGuides #formDistrictFact').val());
				}
				formData.append('district_by_city', $('#formDistrictFact option:selected').text());					
				formData.append('key_region', $('#is_region').val());
				formData.append('key_district', $('#is_district').val());
				formData.append('key_admin', $('#is_admin').val());
				formData.append('guides_place', $('#guides_place').val());*/				
				...
				var err_text = "";		
				if(($('#city_name').val()).length > 0 && ($('#formRegionFact').val()).length > 0 && ($('#formDistrictFact').val()).length > 0){
					formData.append('id', id_edit);				
					formData.append('name', $('#city_name').val());
					formData.append('id_spr_region', $('#formRegionFact').val());
					formData.append('region_by_city', $('#formRegionFact option:selected').text());	
		...
		var type_region_by_city = $('select#formRegionFact').val();
		var name_region_by_city = $('#formRegionFact option:selected').text();
		var type_district_by_city = $('select#formDistrictFact').val();
		var name_district_by_city = $('#formDistrictFact option:selected').text();		
...
//console.log(result);
				if(id_edit>0){
						...
						$('tr.item-'+id_edit+' td[name="region_by_city"]').attr('regionNameFact',$('#formRegionFact').val());
						$('tr.item-'+id_edit+' td[name="district_by_city"]').html(name_district_by_city);
						$('tr.item-'+id_edit+' td[name="district_by_city"]').attr('districtNameFact',$('#formDistrictFact').val());
						
						$('tr.item-'+id_edit+' td[name="is_region"]').html($('#is_region').val() == 1 ? 'да' : 'нет');
						$('tr.item-'+id_edit+' td[name="is_region"]').attr('key_region',($('input#is_region').val() == 1 ? 1 : 0));
						
						$('tr.item-'+id_edit+' td[name="is_district"]').html($('#is_district').val() == 1 ? 'да' : 'нет');
						$('tr.item-'+id_edit+' td[name="is_district"]').attr('key_district',($('input#is_district').val() == 1 ? 1 : 0));
						
						$('tr.item-'+id_edit+' td[name="is_admin"]').html($('#is_admin').val() == 1 ? 'да' : 'нет');
						$('tr.item-'+id_edit+' td[name="is_admin"]').attr('key_admin',($('input#is_admin').val() == 1 ? 1 : 0));
		...
		if($("input[name='is_admin']").prop('checked')){
			  ...
			  $.ajax({
					url: '/ARM/guides/add_adminBycity/',
					type: this.ajaxMethod,
					data: formData,
					cache: false,
					processData: false,
		...
		if($("input[name='is_region']").prop('checked')){
			  ...
			  $.ajax({
					url: '/ARM/guides/add_regionBycity/',
					type: this.ajaxMethod,
					data: formData,
					cache: false,
					processData: false,
		...
		if($("input[name='is_district']").prop('checked')){
			  ...
			  $.ajax({
					url: '/ARM/guides/add_districtBycity/',
					type: this.ajaxMethod,
					data: formData,
					cache: false,
					processData: false,
...
//console.log(result);
				...
				if(($('#formRegionFact').val()).length > 0 && ($('#formDistrictFact').val()).length > 0 && ($('#city_name').val()).length > 0){
					...
					$('#city_name').removeClass("formError");
					guides.closeModalWindow();
...
//console.log(result);
	...
	add_podrazdelenie: function() {
      ...
      $.ajax({
            url: '/ARM/guides/add_podrazdelenie/',
            type: this.ajaxMethod,
            data: formData,
            cache: false,
            processData: false,
