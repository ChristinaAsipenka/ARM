...
use Library\PhpSpreadsheet\Cell\Cell;
use Library\PhpSpreadsheet\Cell\Coordinate;
use Library\PhpSpreadsheet\Chart\Chart;
use Library\PhpSpreadsheet\RichText\RichText;
use Library\PhpSpreadsheet\RichText\Run;
use Library\PhpSpreadsheet\Shared\Drawing as SharedDrawing;
use Library\PhpSpreadsheet\Shared\File;
use Library\PhpSpreadsheet\Shared\Font as SharedFont;
...
use Library\PhpSpreadsheet\Worksheet\Drawing;
...
class Html extends BaseWriter
{
     ...
     *
     * @param Worksheet $pSheet \Library\PhpSpreadsheet\Worksheet\Worksheet
    ...
    /**
     * Create CSS style (\Library\PhpSpreadsheet\Style\Alignment).
     *
     * @param Alignment $pStyle \Library\PhpSpreadsheet\Style\Alignment
     *
     * @return array
     */
    ...
    /**
     * Create CSS style (\Library\PhpSpreadsheet\Style\Font).
     *
     * @return array
     */
    ...
    private function generateRowWriteCell(&$html, $pSheet, $coordinate, $cellType, $cellData, $colSpan, $rowSpan, $cssClass, $colNum, $sheetIndex, $pRow): void
    {
        ...
        if (!$this->useInlineCss && !$this->isPdf) {
            ...
            //** Necessary redundant code for the sake of \Library\PhpSpreadsheet\Writer\Pdf **
    ...
    private function generatePageDeclarations($generateSurroundingHTML)
    {
        ...
        foreach ($sheets as $pSheet) {
            ...
            if ($orientation === \Library\PhpSpreadsheet\Worksheet\PageSetup::ORIENTATION_LANDSCAPE) {
                $htmlPage .= 'size: landscape; ';
            } elseif ($orientation === \Library\PhpSpreadsheet\Worksheet\PageSetup::ORIENTATION_PORTRAIT) {
