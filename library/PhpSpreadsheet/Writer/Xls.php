...
use Library\PhpSpreadsheet\Shared\Escher\DgContainer;
use Library\PhpSpreadsheet\Shared\Escher\DgContainer\SpgrContainer;
use Library\PhpSpreadsheet\Shared\Escher\DgContainer\SpgrContainer\SpContainer;
use Library\PhpSpreadsheet\Shared\Escher\DggContainer;
use Library\PhpSpreadsheet\Shared\Escher\DggContainer\BstoreContainer;
use Library\PhpSpreadsheet\Shared\Escher\DggContainer\BstoreContainer\BSE;
use Library\PhpSpreadsheet\Shared\Escher\DggContainer\BstoreContainer\BSE\Blip;
use Library\PhpSpreadsheet\Shared\OLE;
use Library\PhpSpreadsheet\Shared\OLE\PPS\File;
use Library\PhpSpreadsheet\Shared\OLE\PPS\Root;
...
use Library\PhpSpreadsheet\Writer\Xls\Parser;
use Library\PhpSpreadsheet\Writer\Xls\Workbook;
use Library\PhpSpreadsheet\Writer\Xls\Worksheet;
    ...
    private function buildWorksheetEschers(): void
    {
        ...
        foreach ($this->spreadsheet->getAllsheets() as $sheet) {
            ...
            foreach ($sheet->getDrawingCollection() as $drawing) {
                ...
                $twoAnchor = \Library\PhpSpreadsheet\Shared\Xls::oneAnchor2twoAnchor($sheet, $coordinates, $offsetX, $offsetY, $width, $height);
