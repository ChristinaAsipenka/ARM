var address = {
	...
	selectDistrict: function(addressType, val){
		...
		$.ajax({
            ...
            success: function(result){
				...
				if(window.location.href.indexOf("subject/edit/") != -1 || window.location.href.indexOf("subject/create/") != -1){
	...
	selectPodrazdelenie: function(addressType){
		...
		$.ajax({
            url: '/ARM/basis/address/selectpodrazdelenie/',
            type: this.ajaxMethod,
            data: formData,
            cache: false,
            processData: false,
	...
	selectOtdel: function(addressType){
		...
		$.ajax({
            url: '/ARM/basis/address/selectotdel/',
            type: this.ajaxMethod,
            data: formData,
            cache: false,
            processData: false,
