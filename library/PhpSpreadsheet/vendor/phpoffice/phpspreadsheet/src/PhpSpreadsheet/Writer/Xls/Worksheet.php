...
namespace Library\PhpSpreadsheet\Writer\Xls;

use GdImage;
use Library\PhpSpreadsheet\Cell\Coordinate;
use Library\PhpSpreadsheet\Cell\DataType;
use Library\PhpSpreadsheet\Exception as PhpSpreadsheetException;
use Library\PhpSpreadsheet\RichText\RichText;
use Library\PhpSpreadsheet\RichText\Run;
use Library\PhpSpreadsheet\Shared\StringHelper;
use Library\PhpSpreadsheet\Shared\Xls;
use Library\PhpSpreadsheet\Style\Border;
use Library\PhpSpreadsheet\Style\Color;
use Library\PhpSpreadsheet\Style\Conditional;
use Library\PhpSpreadsheet\Style\Protection;
use Library\PhpSpreadsheet\Worksheet\PageSetup;
use Library\PhpSpreadsheet\Worksheet\SheetView;
...
class Worksheet extends BIFFwriter
{
     ...
     * Formula parser.
     *
     * @var \Library\PhpSpreadsheet\Writer\Xls\Parser
     */
    private $parser;
     ...
     * Sheet object.
     *
     * @var \Library\PhpSpreadsheet\Worksheet\Worksheet
     */
    public $phpSheet;
     ...
     *
     * @var \Library\PhpSpreadsheet\Shared\Escher
     */
    private $escher;
     ...
     * @param \Library\PhpSpreadsheet\Worksheet\Worksheet $phpSheet The worksheet to write
     */
    public function __construct(&$str_total, &$str_unique, &$str_table, &$colors, Parser $parser, $preCalculateFormulas, \Library\PhpSpreadsheet\Worksheet\Worksheet $phpSheet)
    {
     ...
     *
     * @see \Library\PhpSpreadsheet\Writer\Xls\Workbook::storeWorkbook()
     */
    public function close(): void
    {
        ...
        if (($defaultWidth = $phpSheet->getDefaultColumnDimension()->getWidth()) < 0) {
            $defaultWidth = \Library\PhpSpreadsheet\Shared\Font::getDefaultColumnWidthByFont($phpSheet->getParent()->getDefaultStyle()->getFont());
        }
    ...
    private function writeBreaks(): void
    {
        ...
        foreach ($this->phpSheet->getBreaks() as $cell => $breakType) {
            ...
            switch ($breakType) {
                case \Library\PhpSpreadsheet\Worksheet\Worksheet::BREAK_COLUMN:
                    // Add to list of vertical breaks
                    $vbreaks[] = Coordinate::columnIndexFromString($coordinates[0]) - 1;

                    break;
                case \Library\PhpSpreadsheet\Worksheet\Worksheet::BREAK_ROW:
                    // Add to list of horizontal breaks
                    $hbreaks[] = $coordinates[1];

                    break;
                case \Library\PhpSpreadsheet\Worksheet\Worksheet::BREAK_NONE:
                default:
                    // Nothing to do
                    break;
            }
     ...
     * Get Escher object.
     *
     * @return \Library\PhpSpreadsheet\Shared\Escher
     */
     ...
     * Set Escher object.
     *
     * @param \Library\PhpSpreadsheet\Shared\Escher $pValue
     */
    public function setEscher(?\Library\PhpSpreadsheet\Shared\Escher $pValue = null): void
    {
        $this->escher = $pValue;
    }
    ...
    private function writeCFRule(Conditional $conditional): void
    {
        ...
        if ($bFormatFont == 1) {
            ...
            switch ($conditional->getStyle()->getFont()->getUnderline()) {
                case \Library\PhpSpreadsheet\Style\Font::UNDERLINE_NONE:
                    $dataBlockFont .= pack('C', 0x00);
                    $fontUnderline = 0;

                    break;
                case \Library\PhpSpreadsheet\Style\Font::UNDERLINE_DOUBLE:
                    $dataBlockFont .= pack('C', 0x02);
                    $fontUnderline = 0;

                    break;
                case \Library\PhpSpreadsheet\Style\Font::UNDERLINE_DOUBLEACCOUNTING:
                    $dataBlockFont .= pack('C', 0x22);
                    $fontUnderline = 0;

                    break;
                case \Library\PhpSpreadsheet\Style\Font::UNDERLINE_SINGLE:
                    $dataBlockFont .= pack('C', 0x01);
                    $fontUnderline = 0;

                    break;
                case \Library\PhpSpreadsheet\Style\Font::UNDERLINE_SINGLEACCOUNTING:
