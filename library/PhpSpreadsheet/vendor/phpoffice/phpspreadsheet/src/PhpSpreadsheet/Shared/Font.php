...
namespace Library\PhpSpreadsheet\Shared;
...
class Font
{
     ...
     *
     * @param \Library\PhpSpreadsheet\Style\Font $font Font object
     * @param RichText|string $cellText Text to calculate width
     * @param int $rotation Rotation angle
     * @param null|\Library\PhpSpreadsheet\Style\Font $defaultFont Font object
     *
     * @return int Column width
     */
    public static function calculateColumnWidth(\Library\PhpSpreadsheet\Style\Font $font, $cellText = '', $rotation = 0, ?\Library\PhpSpreadsheet\Style\Font $defaultFont = null)
    {
     ...
     */
    public static function getTextWidthPixelsExact(string $text, \Library\PhpSpreadsheet\Style\Font $font, int $rotation = 0): int
    {
     ...
     */
    public static function getTextWidthPixelsApprox($columnText, \Library\PhpSpreadsheet\Style\Font $font, $rotation = 0)
    {
     ...
     *
     * @param \Library\PhpSpreadsheet\Style\Font $font
     *
     ...
     *
     * @param \Library\PhpSpreadsheet\Style\Font $font The workbooks default font
     * @param bool $pPixels true = return column width in pixels, false = return in OOXML units
     *
     * @return mixed Column width
     */
    public static function getDefaultColumnWidthByFont(\Library\PhpSpreadsheet\Style\Font $font, $pPixels = false)
    {
     ...
     */
    public static function getDefaultRowHeightByFont(\Library\PhpSpreadsheet\Style\Font $font)
    {
        switch ($font->getName()) {
            case 'Arial':
                switch ($font->getSize()) {
