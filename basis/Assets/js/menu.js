var menu = {
    ...
    add: function() {
        ...
        $.ajax({
            url: '/ARM/basis/admin/setting/ajaxMenuAdd/',
    ...
    addItem: function(menuId) {
        ...
        var _this = this;
        $.ajax({
            url: '/ARM/basis/admin/setting/ajaxMenuAddItem/',
            type: this.ajaxMethod,
            data: formData,
            processData: false,
            contentType: false,
	 ...
	 updateItem: function(itemId, field, element) {
        ...
        var _this = this;
        $.ajax({
            url: '/ARM/basis/admin/setting/ajaxMenuUpdateItem/',
            type: this.ajaxMethod,
            data: formData,
            processData: false,
            contentType: false,
    ...
    removeItem: function(itemId) {
        ...
        $.ajax({
            url: '/ARM/basis/admin/setting/ajaxMenuRemoveItem/',
            type: this.ajaxMethod,
            data: formData,
            processData: false,
            contentType: false,
