...
<div class="form-group">
	<label for="formTitle" class='label_subject'>Город/населенный пункт:</label>
		...
		<select class="form-controls" name="spr_type_city_post" id="spr_type_city_post">
	...
	<div class="tooltip_post"><button class = "btn_add_fields" onclick="subject.create_url('spr_city'); modalWindow.openModal('openModalGuidesFromSubject')"><i class="icon-plus"></i><span class = "tooltiptext">Добавить новую запись</span></button></div>
</div>
<div class="form-group">
...
<div class="form-group">
	<label for="formTitle" class='label_subject'>Улица:</label>
		<select class="form-controls" name="spr_type_street_post" id="spr_type_street_post">
		<option value='0'>---</option>
...
<div class="form-group">
	<label for="formTitle" class='label_subject'>Квартира:</label>
