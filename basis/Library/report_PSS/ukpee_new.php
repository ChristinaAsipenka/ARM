...
//---------------------------------------------------------------------------создаем форму карточки ---------------------------------------------------------------------------------------------------------------
	...
	$sheet->mergeCells('B'.$r.':G'.($r+1));		$sheet->setCellValue('B'.$r, 'Наименование объекта');
	...
	$sheet->mergeCells('B'.$r.':N'.$r);		$sheet->setCellValue('B'.$r, 'Наименование электротехнологических установок');
	$sheet->mergeCells('O'.$r.':R'.$r);		$sheet->setCellValue('O'.$r, 'Мощность, кВт');
	...
	$spreadsheet->getActiveSheet()->getStyle('A'.$r.':Z'.$r) ->getBorders() ->getallBorders() ->setBorderStyle(\PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN);
	$sheet->mergeCells('A'.$r.':A'.$r);	$sheet->setCellValue('A'.$r, $n++); $sheet->getStyle('A'.$r) ->getFont() ->setSize(8);
	$sheet->mergeCells('B'.$r.':N'.$r);	$sheet->setCellValue('B'.$r, $n++); $sheet->getStyle('B'.$r) ->getFont() ->setSize(8);
	...
	$spreadsheet->getActiveSheet()->getStyle('A'.$r.':Z'.$r) ->getBorders() ->getallBorders() ->setBorderStyle(\PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN);
	$sheet->mergeCells('A'.$r.':A'.$r);	$sheet->setCellValue('A'.$r, $tr); 
	$sheet->mergeCells('B'.$r.':N'.$r);	$sheet->setCellValue('B'.$r, $zap); 
	...
	$spreadsheet->getActiveSheet()->getStyle('A'.$r.':Z'.$r) ->getBorders() ->getallBorders() ->setBorderStyle(\PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN);
	$sheet->mergeCells('A'.$r.':A'.$r);		$sheet->setCellValue('A'.$r, '№ п/п');
	$sheet->mergeCells('B'.$r.':G'.$r);		$sheet->setCellValue('B'.$r, 'Тип и номер линии');
	...
	$spreadsheet->getActiveSheet()->getStyle('A'.$r.':Z'.$r) ->getBorders() ->getallBorders() ->setBorderStyle(\PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN);
	$sheet->mergeCells('A'.$r.':A'.$r);		$sheet->setCellValue('A'.$r, '№ п/п');
	$sheet->mergeCells('B'.$r.':i'.$r);		$sheet->setCellValue('B'.$r, 'Наименование РУ и ТП');
	...
	$spreadsheet->getActiveSheet()->getStyle('A'.$r.':Z'.$r) ->getBorders() ->getallBorders() ->setBorderStyle(\PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN);
	$sheet->mergeCells('A'.$r.':A'.$r);	$sheet->setCellValue('A'.$r, $n++); $sheet->getStyle('A'.$r) ->getFont() ->setSize(8);
	$sheet->mergeCells('B'.$r.':i'.$r);	$sheet->setCellValue('B'.$r, $n++); $sheet->getStyle('B'.$r) ->getFont() ->setSize(8);
	...
	$spreadsheet->getActiveSheet()->getStyle('A'.$r.':Z'.$r) ->getBorders() ->getallBorders() ->setBorderStyle(\PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN);
	$sheet->mergeCells('A'.$r.':A'.$r);	$sheet->setCellValue('A'.$r, $tr); 
	$sheet->mergeCells('B'.$r.':i'.$r);	$sheet->setCellValue('B'.$r, $zap); 
	...
	$spreadsheet->getActiveSheet()->getStyle('A'.$r.':Z'.$r) ->getBorders() ->getallBorders() ->setBorderStyle(\PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN);
	$sheet->mergeCells('A'.$r.':A'.$r);		$sheet->setCellValue('A'.$r, '№ п/п');
	$sheet->mergeCells('B'.$r.':i'.$r);		$sheet->setCellValue('B'.$r, 'Наименование');
	...
	$spreadsheet->getActiveSheet()->getStyle('A'.$r.':Z'.$r) ->getBorders() ->getallBorders() ->setBorderStyle(\PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN);
	$sheet->mergeCells('A'.$r.':A'.$r);		$sheet->setCellValue('A'.$r, '№ п/п');
	$sheet->mergeCells('B'.$r.':E'.$r);		$sheet->setCellValue('B'.$r, 'Тип электронагревателя');
	...
	$spreadsheet->getActiveSheet()->getStyle('A'.$r.':Z'.$r) ->getBorders() ->getallBorders() ->setBorderStyle(\PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN);
	$sheet->mergeCells('A'.$r.':A'.$r);	$sheet->setCellValue('A'.$r, $n++); $sheet->getStyle('A'.$r) ->getFont() ->setSize(8);
	$sheet->mergeCells('B'.$r.':E'.$r);	$sheet->setCellValue('B'.$r, $n++); $sheet->getStyle('B'.$r) ->getFont() ->setSize(8);
	...
	$spreadsheet->getActiveSheet()->getStyle('A'.$r.':Z'.$r) ->getBorders() ->getallBorders() ->setBorderStyle(\PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN);
	$sheet->mergeCells('A'.$r.':A'.$r);	$sheet->setCellValue('A'.$r, $tr); 
	$sheet->mergeCells('B'.$r.':E'.$r);	$sheet->setCellValue('B'.$r, $zap); 
	...
	$spreadsheet->getActiveSheet()->getStyle('A'.$r.':Z'.$r) ->getBorders() ->getallBorders() ->setBorderStyle(\PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN);
	$sheet->mergeCells('A'.$r.':A'.$r);		$sheet->setCellValue('A'.$r, '№ п/п');
	$sheet->mergeCells('B'.$r.':F'.$r);		$sheet->setCellValue('B'.$r, 'Наименование устройства');
	...
	$spreadsheet->getActiveSheet()->getStyle('A'.$r.':Z'.$r) ->getBorders() ->getallBorders() ->setBorderStyle(\PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN);
	$sheet->mergeCells('A'.$r.':A'.$r);	$sheet->setCellValue('A'.$r, $n++); $sheet->getStyle('A'.$r) ->getFont() ->setSize(8);
	$sheet->mergeCells('B'.$r.':F'.$r);	$sheet->setCellValue('B'.$r, $n++); $sheet->getStyle('B'.$r) ->getFont() ->setSize(8);
	...
	$spreadsheet->getActiveSheet()->getStyle('A'.$r.':Z'.$r) ->getBorders() ->getallBorders() ->setBorderStyle(\PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN);
	$sheet->mergeCells('A'.$r.':A'.$r);	$sheet->setCellValue('A'.$r, $tr); 
	$sheet->mergeCells('B'.$r.':F'.$r);	$sheet->setCellValue('B'.$r, $zap); 
	...
	$spreadsheet->getActiveSheet()->getStyle('A'.$r.':Z'.$r) ->getBorders() ->getallBorders() ->setBorderStyle(\PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN);
	$sheet->mergeCells('A'.$r.':A'.$r);		$sheet->setCellValue('A'.$r, '№ п/п');
	$sheet->mergeCells('B'.$r.':F'.$r);		$sheet->setCellValue('B'.$r, 'Наименование / ТИП');
...
//таблица ВЛ КЛ объектов------------------------------------------------------------------------------------------------------------------
	...
	for($tr=0; $tr<count($obj_klvl); $tr++) {
		...
		// заполнение строки-------------------------------------------- 			
			...
			$spreadsheet->getActiveSheet()->getStyle('A'.$r.':Z'.$r) ->getBorders() ->getallBorders() ->setBorderStyle(\PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN);
			$sheet->mergeCells('A'.$r.':A'.$r);	$sheet->setCellValue('A'.$r, $i+1);
			$sheet->mergeCells('B'.$r.':G'.$r);	$sheet->setCellValue('B'.$r, $obj_klvl[$tr]['KLt'].": ".$obj_klvl[$tr]['KLv']."кВ, ".$obj_klvl[$tr]['KLn']); 
...
//таблица ТП РП объектов------------------------------------------------------------------------------------------------------------------
	...
	for($tr=0; $tr<count($obj_trp); $tr++) {
		// заполнение строки-------------------------------------------- 			
			...
			$spreadsheet->getActiveSheet()->getStyle('A'.$r.':Z'.$r) ->getBorders() ->getallBorders() ->setBorderStyle(\PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN);
			$sheet->mergeCells('A'.$r.':A'.$r);	$sheet->setCellValue('A'.$r, $i+1);
			$sheet->mergeCells('B'.$r.':i'.$r);	$sheet->setCellValue('B'.$r, $obj_trp[$tr]['TRPn'].", ".$obj_trp[$tr]['TRPt'].", ".$obj_trp[$tr]['TRPy']); 
...
//таблица АИЭ объектов------------------------------------------------------------------------------------------------------------------
	...
	for($tr=0; $tr<count($obj_aie); $tr++) {
		// заполнение строки-------------------------------------------- 			
			...
			$spreadsheet->getActiveSheet()->getStyle('A'.$r.':Z'.$r) ->getBorders() ->getallBorders() ->setBorderStyle(\PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN);
			$sheet->mergeCells('A'.$r.':A'.$r);	$sheet->setCellValue('A'.$r, $i+1);
			$sheet->mergeCells('B'.$r.':F'.$r);	$sheet->setCellValue('B'.$r, $obj_aie[$tr]['AIEn']." /".$obj_aie[$tr]['AIEt']); 
