<?php $this->theme->header(); ?>
	<!-- LOGO БАЗЫ --->	<div class = "logo_units"><span><i class="icon-settings"></i></span><p>Настройка</p></div>
    <main>
        <div class="container">
											...
											<div class="accordion-content">												
												...
												<div class="mobileTable">									
														<table class="cwdtable" cellspacing="0" cellpadding="1" border="1" id = "q_elektro">
															<thead>
																<tr>
																	<th width="50%" class="t3">Тема / Количество вопросов в билете для групп по ЭБ</th>
																	<th width="10%" class="t3">II гр.	<p class='label_enter' id="q_gr2" name = 'q_gr2'></p></th>
																	<th width="10%" class="t3">III гр.	<p class='label_enter' id="q_gr3" name = 'q_gr3'></p></th>
																	<th width="10%" class="t3">IV гр.	<p class='label_enter' id="q_gr4" name = 'q_gr4'></p></th>
																	<th width="10%" class="t3">V гр.	<p class='label_enter' id="q_gr5" name = 'q_gr5'></p></th>
															...
															<tbody>
																<?php
																	...
																	echo "<td width='10%'><div class='menu-item-event'><button class='button-edit' onclick = \"modalWindow.openModalEdit('ModalTest_theemes',".$test_themes_elektro['id'].")\"><i class='icon-fixed-width icon-pencil'></i></button></div></td>";
																	echo "</tr>";
																	}
																?>
															</tbody>					
												...
												<!------------------------------------------------ Таблица заполнения количества неправильных ответов и количества попыток  у электриков--------------->															
												<div class="mobileTable">
														<table class="cwdtable" cellspacing="0" cellpadding="1" border="1" id = "wrong_a_elektro">
															<thead>
																<tr>
																	<th width="50%" class="t3">Настройка результата</th>
															...
															<tbody>
																<?php
																	...
																	echo "<td width='10%'><div class='menu-item-event'><button class='button-edit' onclick = \"modalWindow.openModalEdit('ModalTest_wrong_answer',".$spr_test_elektro_settings[0]['id'].")\"><i class='icon-fixed-width icon-pencil'></i></button></div></td>";
																	echo "</tr>";
																	...
																	echo "<td width='10%' ><div class='menu-item-event'><button class='button-edit' onclick = \"modalWindow.openModalEdit('ModalTest_attempt',".$spr_test_elektro_settings[1]['id'].")\"><i class='icon-fixed-width icon-pencil'></i></button></div></td>";																																
																	echo "</tr>";
																?>
															</tbody>					
														</table>
					...
					<!---------------------------------- ТЕПЛО -------------------------------------------------------------->
										<div class="accordion-container">
											...
											<!------------------------------------------------ Таблица заполнения количества вопросов по темам у тепловиков--------------------------------------->
														...
														<table class="cwdtable" cellspacing="0" cellpadding="1" border="1" id = "q_teplo">
															<thead>
																<tr>
																	...
																	<th width='40%'	class="t3">Количество вопросов в билете<p class='label_enter' id="q_teplo1" name = 'q_teplo1'></p></th>
																	<th width='10%' class="t3">Операции</th>
																</tr>
															</thead>
															<tbody>
																...
																foreach($spr_test_themes_teplo as $test_themes_teplo){
																	echo "<tr id_test_theemes_teplo='".$test_themes_teplo['id']."'>";
																		...
																		echo "<td width='10%'><div class='menu-item-event'><button class='button-edit' onclick = \"modalWindow.openModalEdit('ModalTest_theemes_teplo',".$test_themes_teplo['id'].")\"><i class='icon-fixed-width icon-pencil'></i></button></div></td>";
																	echo "</tr>";
																}
																?>
															</tbody>					
												...
												<!------------------------------------------------ Таблица заполнения количества неправильных ответов и количества попыток  у тепловиков--------------->							
												<div class="mobileTable">									
														<table class="cwdtable" cellspacing="0" cellpadding="1" border="1" id = "wrong_a_teplo">
															<thead>
																<tr>
																	<th class="t3">Настройка результата</th>
																	<th class="t3">Количество</th>
															...
															<tbody>
																<?php
																	echo "<tr id_test_wrong_answer_t='".$spr_test_teplo_settings[0]['id']."'>";
																		...
																		echo "<td width='10%'><div class='menu-item-event'><button class='button-edit' onclick = \"modalWindow.openModalEdit('ModalTest_wrong_answer_t',".$spr_test_teplo_settings[0]['id'].")\"><i class='icon-fixed-width icon-pencil'></i></button></div></td>";
																	echo "</tr>";
																	...
																	echo "<tr id_test_attempt_t='".$spr_test_teplo_settings[1]['id']."'>";
																		...
																		echo "<td width='10%'><div class='menu-item-event'><button class='button-edit' onclick = \"modalWindow.openModalEdit('ModalTest_attempt_t',".$spr_test_teplo_settings[1]['id'].")\"><i class='icon-fixed-width icon-pencil'></i></button></div></td>";																	
																	echo "</tr>";
																?>
															</tbody>					
														</table>
