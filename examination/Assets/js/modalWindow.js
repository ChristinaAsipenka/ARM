var modalWindow = {
	...
	openModalEditQuestions: function(str, row_id) {
		event.preventDefault();
// row_id - id вопроса

			var formData = new FormData();
			formData.append('id_qstn', row_id);


				$.ajax({
                    url: '/ARM/examination/get_answers_by_question/',
					type: 'POST',
					data: formData,
					cache: false,
					processData: false,
                    ...
                    success: function(result)
                    {
					 ...
					 $('textarea#name_question_elektro').attr('id_question',row_id); 
					 
					 $('textarea#name_a1_electro').val(data[0].answer);  
					 $('textarea#name_a2_electro').val(data[1].answer);  
					 $('textarea#name_a3_electro').val(data[2].answer);  
					 $('textarea#name_a4_electro').val(data[3].answer);
					 
					 $('textarea#name_a1_electro').attr('id_answer',data[0].id);  
					 $('textarea#name_a2_electro').attr('id_answer',data[1].id);  
					 $('textarea#name_a3_electro').attr('id_answer',data[2].id);  
					 $('textarea#name_a4_electro').attr('id_answer',data[3].id);
					 
					 $('input#true_question1').val(data[0].id);
					 $('input#true_question2').val(data[1].id);
					 $('input#true_question3').val(data[2].id);
					 $('input#true_question4').val(data[3].id);
						

					 
					 if(data[0].mark == 1){
						 $('input#true_question1').prop('checked', true);
						 $('textarea#name_a1_electro').css({'background-color': 'aquamarine'});				 
					 };  
					 
					 if(data[1].mark == 1){
						 $('input#true_question2').prop('checked', true);
						 $('textarea#name_a2_electro').css({'background-color': 'aquamarine'});
								 
					 };
					 if(data[2].mark == 1){
						 $('input#true_question3').prop('checked', true);
						 $('textarea#name_a3_electro').css({'background-color': 'aquamarine'});
					 					 
					 };
					 if(data[3].mark == 1){
						 $('input#true_question4').prop('checked', true);
						 $('textarea#name_a4_electro').css({'background-color': 'aquamarine'});
	...
	$name_question = $('tr[id_question_elekto="'+row_id+'"] td[name="name_question_elektro"]').text();
	$('textarea#name_question_elektro').val($name_question);
	
	
	
	id_theme = $('tr[id_question_elekto="'+row_id+'"]').attr('id_themes_elekto');
	$('select[name="name_theme_question_elektro"] option[value="'+id_theme+'"]').prop('selected', true);
  ...
  openModalEditQuestionsTeplo: function(str, row_id) {
		event.preventDefault();
// row_id - id вопроса
			...
			formData.append('id_qstn', row_id);
				...
				$.ajax({
                    url: '/ARM/examination/get_answers_by_question_teplo/',
					type: 'POST',
					data: formData,
					cache: false,
					processData: false,
                    ...
                    success: function(result)
                    {
					 ...
					 /* $("div[class='modalDialog_guidesfromOtv']").html(data);
					   $("div#openModalGuides").css({'display': 'block'});*/
					 $('textarea#name_question_teplo').attr('id_question',row_id); 
					 
					 $('textarea#name_a1_teplo').val(data[0].answer);  
					 $('textarea#name_a2_teplo').val(data[1].answer);  
					 $('textarea#name_a3_teplo').val(data[2].answer);  
					 $('textarea#name_a4_teplo').val(data[3].answer);
					 
					 $('textarea#name_a1_teplo').attr('id_answer',data[0].id);  
					 $('textarea#name_a2_teplo').attr('id_answer',data[1].id);  
					 $('textarea#name_a3_teplo').attr('id_answer',data[2].id);  
					 $('textarea#name_a4_teplo').attr('id_answer',data[3].id);
					 
					 $('input#true_question_t1').val(data[0].id);
					 $('input#true_question_t2').val(data[1].id);
					 $('input#true_question_t3').val(data[2].id);
					 $('input#true_question_t4').val(data[3].id);
						

					 
					 if(data[0].mark == 1){
						 $('input#true_question_t1').prop('checked', true);
						 $('textarea#name_a1_teplo').css({'background-color': 'aquamarine'});				 
					 };  
					 
					 if(data[1].mark == 1){
						 $('input#true_question_t2').prop('checked', true);
						 $('textarea#name_a2_teplo').css({'background-color': 'aquamarine'});
								 
					 };
					 if(data[2].mark == 1){
						 $('input#true_question_t3').prop('checked', true);
						 $('textarea#name_a3_teplo').css({'background-color': 'aquamarine'});
					 					 
					 };
					 if(data[3].mark == 1){
						 $('input#true_question_t4').prop('checked', true);
						 $('textarea#name_a4_teplo').css({'background-color': 'aquamarine'});
	...
	$name_question = $('tr[id_question_teplo="'+row_id+'"] td[name="name_question_teplo"]').text();
	$('textarea#name_question_teplo').val($name_question);
	
	
	
	id_theme = $('tr[id_question_teplo="'+row_id+'"]').attr('id_themes_teplo');
	$('select[name="name_theme_question_teplo"] option[value="'+id_theme+'"]').prop('selected', true);
	...
	closeModal: function(str) 
	{
		...
		$('#error_otv_instr').html('');
			...
			$('#ModalQuestion_elekto textarea[name=name_question_elektro]').attr('id_question','');
			$('#ModalQuestion_elekto input').removeClass("formError");
			$('#ModalQuestion_elekto textarea').removeClass("formError");
			$('#ModalQuestion_elekto select').removeClass("formError");
			$('#ModalQuestion_elekto #true_question1').val(1);
			$('#ModalQuestion_elekto #true_question2').val(2);
			$('#ModalQuestion_elekto #true_question3').val(3);
			$('#ModalQuestion_elekto #true_question4').val(4);
			...
			$('#ModalQuestion_teplo textarea[name=name_question_teplo]').attr('id_question','');
			$('#ModalQuestion_teplo input').removeClass("formError");
			$('#ModalQuestion_teplo textarea').removeClass("formError");
			$('#ModalQuestion_teplo select').removeClass("formError");
			
			$('#ModalQuestion_teplo #true_question_t1').val(1);
			$('#ModalQuestion_teplo #true_question_t2').val(2);
			$('#ModalQuestion_teplo #true_question_t3').val(3);
			$('#ModalQuestion_teplo #true_question_t4').val(4);
